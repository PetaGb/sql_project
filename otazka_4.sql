...
WITH salary_price_comparison AS (
	SELECT
		CONCAT(current_year, ' - ', prev_year) AS period,
...
SELECT
	period, 
	food_price_growth - salary_growth AS real_price_growth,
	salary_growth,
	food_price_growth
FROM salary_price_comparison
ORDER BY real_price_growth DESC;
